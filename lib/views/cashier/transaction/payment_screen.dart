                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                Text('Tanggal: ${DateFormat('yyyy-MM-dd HH:mm:ss').format(trx.transactionDate)}', style: const TextStyle(color: Colors.white70, fontFamily: 'Montserrat')),
                                Text('Metode: ${trx.paymentMethod}', style: const TextStyle(color: Colors.white70, fontFamily: 'Montserrat')),
                              ],
                            ),
                            const SizedBox(height: 8),
